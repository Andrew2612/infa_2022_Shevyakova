...
def pause_execution():
    ...
    write_space_objects_data_to_file(output, space_objects)
    perform_execution = False
...
def init_ui(screen):
    ...
    button_load_1 = thorpy.make_button(text="Solar system", func=open_file_1)
    button_load_2 = thorpy.make_button(text="Double star", func=open_file_2)
    button_load_3 = thorpy.make_button(text="One satellite", func=open_file_3)
